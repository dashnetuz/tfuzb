...
$languages = [
    'en' => ['label' => 'English (UK)', 'flag' => 'icon-flag-en.svg'],
    'uz' => ['label' => 'O‘zbekcha (Uz)', 'flag' => 'icon-flag-uz.svg'],
    'ru' => ['label' => 'Русский (Ru)', 'flag' => 'icon-flag-ru.svg'],
];

$currentLang = Yii::$app->language;

$user = AuthHelper::getUser();
$avatar = !empty($user['avatar']) ? $user['avatar'] : '/template/assets/images/profile/user-1.jpg';
    ...
    <div class="with-vertical">
        ...
        <nav class="navbar navbar-expand-lg p-0">
                            ...
                            <div class="position-relative">
                                <div class="row">
                                    ...
                                    <div class="col-4 d-none d-lg-flex">
                                        <img src="/template/assets/images/backgrounds/mega-dd-bg.jpg" alt="mega-dd" class="img-fluid mega-dd-bg" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="d-block d-lg-none py-9 py-xl-0">
                <img src="<?= $setting && $setting->logo_bottom ? Html::encode($setting->logo_bottom) : '/template/assets/images/logos/logo.svg' ?>" alt="Logo-img" />
            </div>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <div class="d-flex align-items-center justify-content-between">
                    <ul class="navbar-nav flex-row mx-auto ms-lg-auto align-items-center justify-content-center">
                        ...
                        <!-- ------------------------------- -->
                        <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                            <a class="nav-link" href="javascript:void(0)" id="langDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="/template/assets/images/flag/<?= $languages[$currentLang]['flag'] ?>" alt="flag" width="20" height="20" class="rounded-circle object-fit-cover round-20" />
                            </a>
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="langDropdown">
                                <div class="message-body">
                                    <?php foreach ($languages as $code => $lang): ?>
                                    <a href="<?= UrlHelper::createLanguageUrl($code) ?>"
                                       class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item<?= $code === $currentLang ? ' active' : '' ?>">
                                        <div class="position-relative">
                                            <img src="/template/assets/images/flag/<?= $lang['flag'] ?>"
                                                 alt="<?= $lang['label'] ?>" width="20" height="20"
                                                 class="rounded-circle object-fit-cover round-20" />
                                        </div>
                                        <p class="mb-0 fs-3"><?= $lang['label'] ?></p>
                                    </a>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="javascript:void(0)" id="drop1" aria-expanded="false">
                                <div class="d-flex align-items-center gap-2 lh-base">
                                    <img src="<?= Html::encode($avatar) ?>" class="rounded-circle" width="35" height="35" alt="matdash-img" />
                            ...
                            <div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                                <div class="position-relative px-4 pt-3 pb-2">
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom gap-6">
                                        <img src="<?= Html::encode($avatar) ?>" class="rounded-circle" width="56" height="56" alt="matdash-img" />
                                        <div>
                                            <h5 class="mb-0 fs-12"><?= Html::encode($user['username'] ?? '---') ?>
                                                <span class="text-success fs-11">
                                                    <?= implode(', ', array_slice($user['roles'] ?? [], 0, 2)) ?>
                                                </span>
                                            </h5>
                                    ...
                                    <div class="message-body">
                                        <a href="<?= Url::to(['dashboard/profile']) ?>" class="p-2 dropdown-item h6 rounded-1">
                                            My Profile
                                        </a>
                                        <a href="<?= Url::to(['auth/logout']) ?>" class="p-2 dropdown-item h6 rounded-1">
                                            Log Out
                                        </a>
                                    </div>
                                </div>
            ...
            <nav class="sidebar-nav scroll-sidebar">
                <div class="offcanvas-header justify-content-between">
                    <a href="/dashboard" class="text-nowrap logo-img">
                        <img src="/template/assets/images/logos/logo-icon.svg" alt="Logo" />
                    </a>
            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item d-none d-xl-flex align-items-center">
                    <a href="/dashboard" class="text-nowrap nav-link">
                        <img src="/template/assets/images/logos/logo.svg" alt="matdash-img" />
                    </a>
                </li>
                ...
                <div class="d-flex align-items-center justify-content-between px-0 px-xl-8">
                    <ul class="navbar-nav flex-row mx-auto ms-lg-auto align-items-center justify-content-center">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="javascript:void(0)" id="drop1" aria-expanded="false">
                                <div class="d-flex align-items-center gap-2 lh-base">
                                    <img src="/template/assets/images/profile/user-1.jpg" class="rounded-circle" width="35" height="35" alt="matdash-img" />
                                    <iconify-icon icon="solar:alt-arrow-down-bold" class="fs-2"></iconify-icon>
                                </div>
                            </a>
                            <div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                                <div class="position-relative px-4 pt-3 pb-2">
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom gap-6">
                                        <img src="/template/assets/images/profile/user-1.jpg" class="rounded-circle" width="56" height="56" alt="matdash-img" />
                                        <div>
