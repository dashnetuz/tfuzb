            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-5 text-center text-md-end">
                        <img src="/template/assets/images/backgrounds/welcome-bg.png" alt="welcome" class="img-fluid mb-n7 mt-2" width="180" />
                    </div>
                </div>
                        ...
                        <div class="table-responsive" data-simplebar>
                            <table class="table text-nowrap align-middle table-custom mb-0 last-items-borderless">
                                ...
                                <tr>
                                    <td class="ps-0">
                                        <div class="d-flex align-items-center gap-6">
                                            <img src="/template/assets/images/products/dash-prd-1.jpg" alt="prd1" width="48" class="rounded" />
                                            <div>
                                ...
                                <tr>
                                    <td class="ps-0">
                                        <div class="d-flex align-items-center gap-6">
                                            <img src="/template/assets/images/products/dash-prd-2.jpg" alt="prd1" width="48" class="rounded" />
                                            <div>
                                ...
                                <tr>
                                    <td class="ps-0">
                                        <div class="d-flex align-items-center gap-6">
                                            <img src="/template/assets/images/products/dash-prd-3.jpg" alt="prd1" width="48" class="rounded" />
                                            <div>
                                ...
                                <tr>
                                    <td class="ps-0">
                                        <div class="d-flex align-items-center gap-6">
                                            <img src="/template/assets/images/products/dash-prd-4.jpg" alt="prd1" width="48" class="rounded" />
                                            <div>
