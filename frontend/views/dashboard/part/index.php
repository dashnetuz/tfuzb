    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                <?= Html::a(Yii::t('app', 'Yangi qism qo‘shish'), ['part-create', 'lesson_id' => $lesson_id], ['class' => 'btn btn-success']) ?>
                <?= Html::a(Yii::t('app', 'Tartibni o‘zgartirish'), ['part-position', 'lesson_id' => $lesson_id], ['class' => 'btn btn-secondary']) ?>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-wrap" style="word-break: break-word;">
                                <div class="action-btn d-flex justify-content-center gap-2">
                                    <?= Html::a('<i class="ti ti-menu fs-5"></i>', ['dashboard/part-position', 'lesson_id' => $lesson_id], [
                                        'class' => 'text-info', 'title' => Yii::t('app', 'Position')
                                    ]) ?>
                                    <?= Html::a('<i class="ti ti-list-details fs-5"></i>', ['dashboard/part-content-index', 'part_id' => $item->id], [
                                        'class' => 'text-info', 'title' => Yii::t('app', 'Qismlar ro‘yxati')
                                    ]) ?>
                                    <?= Html::a('<i class="ti ti-pencil fs-5"></i>', ['dashboard/part-update', 'id' => $item->id], [
                                        'class' => 'text-primary', 'title' => Yii::t('app', 'Tahrirlash')
                                    ]) ?>
                                    <?= Html::a('<i class="ti ti-trash fs-5"></i>', ['dashboard/part-delete', 'id' => $item->id], [
