...
/** @var common\models\Course[] $models */
/** @var int $course_id */
/** @var int $category_id */
?>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                <?= Html::a(Yii::t('app', 'Yangi kurs qo‘shish'), ['course-create', 'category_id' => $category_id], ['class' => 'btn btn-success']) ?>
                <?= Html::a(Yii::t('app', 'Tartibni o‘zgartirish'), ['course-position', 'category_id' => $category_id], ['class' => 'btn btn-secondary']) ?>
            </div>
