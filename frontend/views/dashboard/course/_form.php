...
// Slugify binding
$this->registerJs(<<<JS
    bindSlugify('#course-title_uz', '#course-url_uz');
    bindSlugify('#course-title_ru', '#course-url_ru');
    bindSlugify('#course-title_en', '#course-url_en');
JS);
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="hidden-description-uz" name="Course[description_uz]" style="display:none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="hidden-description-ru" name="Course[description_ru]" style="display:none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="hidden-description-en" name="Course[description_en]" style="display:none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="mb-3">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <input type="file" id="pictureInput" name="Course[picture]" class="form-control" accept="image/*">
                </div>
                <div class="col-lg-4">
                    <div class="mt-3">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center my-4">
                        ...
                        <input type="hidden" name="Course[is_active]" value="0">
