...
// Slugify binding
$this->registerJs(<<<JS
    bindSlugify('#category-title_uz', '#category-url_uz');
    bindSlugify('#category-title_ru', '#category-url_ru');
    bindSlugify('#category-title_en', '#category-url_en');
JS);
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="hidden-description-uz" name="Category[description_uz]" style="display:none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="hidden-description-ru" name="Category[description_ru]" style="display:none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="hidden-description-en" name="Category[description_en]" style="display:none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="mb-3">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <input type="file" id="pictureInput" name="Category[picture]" class="form-control" accept="image/*">
                </div>
                <div class="col-lg-4">
                    <div class="mt-3">
