...
/** @var common\models\Lesson[] $models */
/** @var int $lesson_id */
/** @var int $course_id */
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                <?= Html::a(Yii::t('app', 'Yangi dars qo‘shish'), ['lesson-create', 'course_id' => $course_id], ['class' => 'btn btn-success']) ?>
                <?= Html::a(Yii::t('app', 'Tartibni o‘zgartirish'), ['lesson-position', 'course_id' => $course_id], ['class' => 'btn btn-secondary']) ?>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-wrap" style="word-break: break-word;">
                                <div class="action-btn d-flex justify-content-center gap-2">
                                    <?= Html::a('<i class="ti ti-menu fs-5"></i>', ['dashboard/part-index', 'lesson_id' => $item->id], [
                                        'class' => 'text-info', 'title' => Yii::t('app', 'Qismlar ro‘yxati')
                                    ]) ?>
                                    <?= Html::a('<i class="ti ti-pencil fs-5"></i>', ['dashboard/lesson-update', 'id' => $item->id], [
                                        'class' => 'text-primary', 'title' => Yii::t('app', 'Tahrirlash')
                                    ]) ?>
                                    <?= Html::a('<i class="ti ti-trash fs-5"></i>', ['dashboard/lesson-delete', 'id' => $item->id], [
